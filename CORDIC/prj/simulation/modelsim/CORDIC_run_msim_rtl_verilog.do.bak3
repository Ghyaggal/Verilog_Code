...
vlog -vlog01compat -work work +incdir+E:/verilog/CORDIC/rtl {E:/verilog/CORDIC/rtl/CORDIC.v}

vlog -vlog01compat -work work +incdir+E:/verilog/CORDIC/prj/../sim {E:/verilog/CORDIC/prj/../sim/CORDIC_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  CORDIC_tb
